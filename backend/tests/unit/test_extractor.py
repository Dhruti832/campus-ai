...
from app.ingestion.extractor import clean_text, extract_docx_text, extract_html, extract_pdf_text
...
class TestExtractDocxText:
    def test_extracts_paragraph_text_from_generated_docx(self):
        document = Document()
